namespace _Project.CodeBase.Infrastructure.Constants
{
  public static class AssetAddress
  {
    ...
    public const string BuildingIndicatorsPopUp = "UI_InGame/BuildingIndicatorsPopUp";
    public const string TradeResourceItem = "UI_InGame/TradeResourceItem";
    public const string TradeWindow = "UI_InGame/TradeWindow";
    public const string PaymentItem = "UI_InGame/PaymentItem";
    public const string SaveSelectionWindow = "UI_Menu/SaveSelectionWindow";
