...
namespace _Project.CodeBase.Gameplay.Services.Grid
{
  public static class GridUtils
  {
    ...
    private static Vector2Int _gameFieldBottomLeft = new(-5, -5);
    private static Vector2Int _gameFieldTopRight = new(5, 5);

    public static Vector3 GetSnappedPosition(Vector3 worldPosition)
    {
    ...
    public static Vector3 GetSnappedPosition(Vector3 worldPosition, Vector2Int size)
    {
    ...
    public static Vector3 GetWorldPivot(Vector2Int cell)
    {
    ...
    public static Vector2Int GetCell(Vector3 snappedPosition)
    {
      return new Vector2Int(Mathf.RoundToInt(snappedPosition.x), Mathf.RoundToInt(snappedPosition.z));
    }

    public static List<Vector2Int> GetCells(Vector3 snappedPosition, Vector2Int size)
    {
